...
export async function initLocator(worker: CalendarWorkerImpl, browserData: BrowserData) {
	...
	// fixme: use both resolveTypeReference
	locator.instancePipeline = new InstancePipeline(clientModelInfo.resolveTypeReference, clientModelInfo.resolveTypeReference)
